# 30Days_Challenge
Trying to solve problems - Logical Thinking Based, Applied Programming
-------------------------------------------------------------------------------------------------------------------------------------
Day-1 : Simple Java Basics question
Question:1 -> Program to Print Integer Numbers Entered by the User:
...
Question:2 -> Write a Program to Find the Size of int, float, double, and char on Your Computer:
